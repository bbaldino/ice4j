 ...
 */
public class MultiplexingDatagramSocket2
    extends MultiplexingDatagramSocket
{
  /**
        ...
        throws SocketException
    {
      return
          new MultiplexedDatagramSocket(
              MultiplexingDatagramSocket2.this,
              filter);
    }
      ...
      = new SocketReceiveBuffer()
  {
    ...
    public int getReceiveBufferSize()
        throws SocketException
    {
      return MultiplexingDatagramSocket2.this.getReceiveBufferSize();
    }
  };
  ...
  /**
   * Initializes a new <tt>MultiplexingDatagramSocket2</tt> instance which is
   ...
   */
  public MultiplexingDatagramSocket2()
      throws SocketException
  {
    startReaderThread();
  }
   ...
   * instance
   */
  public MultiplexingDatagramSocket2(DatagramSocket delegate)
      throws SocketException
  {
    super(delegate);
    startReaderThread();
   ...
   */
  public MultiplexingDatagramSocket2(int port)
      throws SocketException
  {
    super(port);
    startReaderThread();
   ...
   */
  public MultiplexingDatagramSocket2(int port, InetAddress laddr)
      throws SocketException
  {
    super(port, laddr);
    startReaderThread();
   ...
   */
  public MultiplexingDatagramSocket2(SocketAddress bindaddr)
      throws SocketException
  {
    super(bindaddr);
    startReaderThread();
    ...
    readerThread = new Thread(new Runnable() {
      ...
      public void run() {
        while (true) {
          ...
          try {
            MultiplexingDatagramSocket2.super.receive(packet);
          } catch (IOException e) {
